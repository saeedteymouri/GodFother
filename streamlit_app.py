...
def main():
    ...
    for i, char in enumerate(characters):
        character_names_1[char] = st.text_input(f"Person {i+1} (Night 1):", character_names_1[char])
    ...
    if any(character_names_1.values()):
        df = pd.DataFrame({"Character": characters, "Name": [character_names_1[char] for char in characters]})
